...
public class JsoupUtil {
	...
	private void fetchHrefList(String url) throws IOException {
	...
	private void parse(String html) {
		...
		Elements links = doc.select("div.pg-invest-list");

		print("links.size(): (%d)", links.size());
	...
	public static void main(String[] args) {
		...
		String url = "http://www.jr1.cn/index.php?m=P2P";
